...
import java.sql.*;
public class MySQLImplPatient extends DatabaseImpl{
    private final String TABLE_NAME = "person";
    private final String SQL_INSERT = "INSERT INTO " + TABLE_NAME + " (nomComplet, type, antecedent, specialite) VALUES (?, 'patient', ?, NULL)";
